...
SERIALIZABLE_DECLARATION(Triangle)
    INSTANTIABLE_KEY(EIGHTSER_TYPE_HASH(Cyrcle), S) // export Triangle as Cyrcle - will collide
...
{
    using eightser::dynamic::instantiable_registry;
...
TEST(TestLibrary, TestAccess)
{
    ...
    using instantiable_registry_type = eightser::dynamic::instantiable_registry_t;
...
#include <Eightser/BuiltIn/unique_ptr.hpp>
