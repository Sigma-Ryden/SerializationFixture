...
#undef _FACTORY_REGISTRY_DECLARATION
...
#undef _SERIALIZATION_CALL_DECLARATION
#undef _SERIALIZATION_CALL_IMPLEMENTATION
...
#undef _CONDITIONAL_SERIALIZABLE_IMPLEMENTATION
#undef CONDITIONAL_SAVE_SERIALIZABLE
#undef CONDITIONAL_LOAD_SERIALIZABLE
#undef _SERIALIZABLE_IMPLEMENTATION
