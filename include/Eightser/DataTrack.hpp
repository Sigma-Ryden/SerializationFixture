#ifndef EIGHTSER_DATA_TRACK_HPP
#define EIGHTSER_DATA_TRACK_HPP
...
void native_save(ArchiveType&, PointerType&, ::xxeightser_instantiable_traits_key_type) noexcept { /*pass*/ }
