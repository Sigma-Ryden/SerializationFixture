...
#ifndef EIGHTSER_CORE_MEMORY_HPP
#define EIGHTSER_CORE_MEMORY_HPP
...
template <typename SerializableType,
          EIGHTSER_REQUIRES(std::negation<std::is_polymorphic<SerializableType>>::value)>
...
template <typename SerializableType,
          EIGHTSER_REQUIRES(std::is_polymorphic<SerializableType>::value)>
...
#endif // EIGHTSER_CORE_MEMORY_HPP
